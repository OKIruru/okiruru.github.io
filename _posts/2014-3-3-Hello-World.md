---
layout: post
title: Тестовая запись Jekyll
published: true
---

Это обычная тестовая запись, тут должно быть много рыбы и всего такого...

![Скрин какого-то сайта]({{site.baseurl}}/_posts/Screenshot_1.png)
